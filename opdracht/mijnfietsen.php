...
$sql = "SELECT * FROM fietsen  JOIN gebruikers ON gebruikers.id = fietsen.eigenaar where eigenaar = 3";
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="mijnfietsen.php">
              Mijn Fietsen
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="klant_reparatie.php">
              klant_reparatie
            </a>
          </li>
