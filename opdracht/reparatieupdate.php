...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
            <h1 class="h2">Update Reparatie</h1>
        ...
        <div class="container">
            ...
            <form action="" method="post">
                <div class="col-6"></div>
                <input type="text" name="Titel" class="form-control" value="<?php echo $database_gegevens['Titel']; ?>">
                <input type="text" name="Opmerkingen" class="form-control" value="<?php echo $database_gegevens['Opmerkingen']; ?>">
                <input type="text" name="Kosten" class="form-control" value="<?php echo $database_gegevens['Kosten']; ?>">
                <input type="text" name="Datum" class="form-control" value="<?php echo $database_gegevens['Datum']; ?>">
                <input type="text" name="Medewerker" class="form-control" value="<?php echo $database_gegevens['Medewerker']; ?>">
