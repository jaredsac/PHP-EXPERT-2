...
$sql = "SELECT * FROM gebruikers where rol = \"klant\";";
      ...
      <div class="table-responsive">
        ...
        <thead>
          ...
          <tbody>
            ...
            <tr>
                <td><?php echo $items['Voornaam']?></td>
                <td><?php echo $items['Achternaam']?></td>
                <td><?php echo $items['Telefoonnummer']?></td>
                <td><?php echo $items['Email']?></td>
                <td><?php echo $items['Wachtwoord']?></td>
                <td><?php echo $items['Rol']?></td>
                <td>
                <a href="klantdelete.php?id=<?php echo $items['ID']?>">DELETE</a>
                </td>
                <td>
                <a href="klantupdate.php?id=<?php echo $items['ID']?>">UPDATE</a>
                </td>
            </tr>
            <?php endforeach;?>
          </tbody>
